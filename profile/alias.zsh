alias ls='\ls --color=auto --almost-all --classify --human-readable -v'
alias  l='\ls --color=auto --all --classify --human-readable -v -l'
alias le='\ls --color=always --all --classify --human-readable -v -l|less -N'
