...
alias c++g='clang++ -std=c++1y -stdlib=libc++ -Wall -Werror -Wextra -O0 -g'
alias ccg='clang -std=c11 -Wall -Werror -Wextra -O0 -g'
...
alias markdown2pdf='pandoc -f markdown -s -N --listings --latex-engine=xelatex -V mainfont=Ricty -V sansfont=Ricty -V monofont=Ricty -V geometry:margin=1cm'
...
alias tree="tree -C"
alias u='updatedb'
alias voicememo='arecord -t raw -f S16_LE -r 32000|speexenc -V --quality 10 --comp 10 --vbr --rate 32000 --le --16bit - `date --iso-8601`.spx'
