...
alias mkbackup='sudo mksquashfs /etc /home /root /usr/local /var $(date --iso-8601)_$(hostname).sfs -comp zstd -noappend -wildcards -e "... *.sfs" "... .cache" "... .stack" "... .stack-work" "... Cache" "... Steam" "... _cache" "... cache" "... dist" "... node_modules" "... target"'
