...
alias mkbackup='sudo mksquashfs /etc /home /root /usr/local /var $(date --iso-8601)_$(hostname).sfs -comp xz -noappend -e .cache .stack-work _cache backup cache dist node_modules'
...
alias optipng-best='optipng -fix -preserve -o7'
