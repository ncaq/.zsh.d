...
alias cb='cabal build --disable-optimization --enable-tests all'
alias cbw='cb --ghc-options="-Werror"'
alias cdu='cd $(readlink -f ~/Documents/current/)'
alias claude!='claude --allow-dangerously-skip-permissions'
alias ct='cabal test --disable-optimization --enable-tests'
alias cta='ct all'
alias dcu='docker compose up --build; docker compose down'
alias e='emacsclient --reuse-frame --alternate-editor=emacs'
alias en='e --no-wait'
alias et='e --tty'
...
alias gd='git add --intent-to-add --all . && git diff HEAD'
alias gf='git pull --progress --all --keep'
alias gi='claude --effort medium /commit'
...
alias gu='claude --effort medium /pr'
...
alias na='nix profile add --file "<nixpkgs>"'
alias nb='nix-fast-build --no-link --skip-cached'
alias nc='nix flake check'
alias nf='nix fmt'
alias nfc='nf -- --ci'
alias nkfu='nkf -w -x -Lu'
alias nkfw='nkf -w -x -Lu --overwrite'
alias nr='nix profile remove --all'
alias nrun='nix run --file "<nixpkgs>"'
alias o='dwim-open'
